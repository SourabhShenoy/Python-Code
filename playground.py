...
#8.1,8.2,14,17,18,19,20,21,22,24
import os
import random
...
class LinkedList(object):
	...
	def ispalindrome(self,right):
		...
		if right is None:
			...
			self.ispalindrome(right.get_next())
		...
		print(str(right.get_data()) + " " + str(left.get_data()) + " " + str(res))
		left = left.get_next()
...
#			list_1.ispalindrome(list_1.head,list_1.head)
			temp = random_list(10)
			temp.display()
			...
			print("Remove Dup Yet to be implemented!\n")
		elif option == '18':
			print("Swap 2 nodes Yet to be implemented!\n")
		elif option == '19':
			print("Last to First Yet to be implemented!\n")
		elif option == '20':
			...
			print("Middle of list Yet to be implemented!\n")
		elif option == 'q':
			os.system('clear')
			exit(0)
		elif option == 'c':
