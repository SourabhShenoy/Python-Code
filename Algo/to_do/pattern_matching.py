#Naive Pattern Searching, KMP Algorithm, Rabin-Karp Algorithm, Boyer Moore Algorithm
#Suffix Array, Anagram Substring Search (Or Search for all permutations)
#Pattern Searching using a Trie of all Suffixes, Aho-Corasick
